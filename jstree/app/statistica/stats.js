steal("jstree/highcharts").then(function () {
    ...
    Abi.View.ChartAwards = Abi.View.Base.extend({
        events: {
    ...
    Abi.View.ChartCommentCount = Abi.View.Base.extend({
        initialize: function () {
    ...
    Abi.View.Chart = Abi.View.Base.extend({
        events: {
            "click .nav a": "goToTab"
        },
    ...
    Abi.View.HelloWorld = Abi.View.Base.extend({
        render: function () {
